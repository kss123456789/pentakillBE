...
public class PageResponseScheduleByDateDto<K, V> {
    ...
    private Map<LocalDate, List<LeagueScheduleResponseDto>> data;
    private int year;
    private int month;
    ...
    public PageResponseScheduleByDateDto(int statusCode, String message, Map<LocalDate, List<LeagueScheduleResponseDto>> data, int year, int month,
