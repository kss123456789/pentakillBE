        ...
        try {
            ...
            for (JsonNode rootNode : events) {
                ...
                if (checkSchedule == null) { // 중복 값이 없는 경우 저장
                    ...
                    String team1Outcome = teamsNode.get(0).get("result").get("outcome").asText();
                    int team1GameWins = teamsNode.get(0).get("result").get("gameWins").asInt();
                    int team1RecordWins = teamsNode.get(0).get("record").get("wins").asInt();
                    int team1RecordLosses = teamsNode.get(0).get("record").get("losses").asInt();
                    ...
                    String team2Outcome = teamsNode.get(1).get("result").get("outcome").asText();
                    int team2GameWins = teamsNode.get(1).get("result").get("gameWins").asInt();
                    int team2RecordWins = teamsNode.get(1).get("record").get("wins").asInt();
                    int team2RecordLosses = teamsNode.get(1).get("record").get("losses").asInt();
